...
const LoginForm = ({ 
  ...
  const buttonBg = isAdmin ? 'bg-purple-600 hover:bg-purple-700' : 'bg-indigo-600 hover:bg-indigo-700';
  const title = isAdmin ? 'Admin Dashboard' : 'Booking System';
  const subtitle = isAdmin ? 'Sign in with admin credentials' : 'Sign in to manage your appointments';
